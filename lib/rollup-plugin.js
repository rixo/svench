...
module.exports = ({
  ...
  return {
    ...
    options(options) {
      if (options.plugins.find(x => x.name === beforeSvelte.name)) return
      ...
      // options.plugins.push(afterSvelte)
      // options.plugins.splice(svelteIndex + 1, 0, afterSvelte)
      // options.plugins.splice(svelteIndex, 0, beforeSvelte)
