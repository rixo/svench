...
test('does not replace provided source', macro, {
  ...
  expected: `
    ...
    <script context="module">
      ...
      export const __svench_options = {"opt":"foo","bool":true}
    </script>
  `,
})
...
test('adds id to file with context module', macro, {
  ...
  expected: `
    <script context="module">
      const foo = 12
    ;export const __svench_id = "1dcdr30"; export const __svench_views = []; export const __svench_options = {}</script>
...
test('default view name', macro, {
  ...
  expected: `
    ...
    <script context="module">
      export const __svench_id = "1dcdr30"
      export const __svench_views = ["View 1","View 2","View 4","View 4 (1)","Conflict!","Conflict! (1)"]
      export const __svench_options = {}
    </script>
  `,
})
...
test('parse options', macro, {
  ...
  expected: `
    ...
    <script context="module">
      export const __svench_id = "1dcdr30"
      export const __svench_views = ["whatever"]
      export const __svench_options = {"foo":"bar","baz":false}
    </script>
  `,
})
